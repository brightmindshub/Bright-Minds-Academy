...
import { GermanOverview } from "@/app/german/GermanOverview";
import { BeforeAfterGerman } from "@/app/german/BeforeAfterGerman";

const germanFaqs = [
  {
    question: "Who can take this course?",
    answer:
      "Anyone from beginner to advanced level who wants to learn German for travel, work, study, or personal growth.",
  },
  {
    question: "How long does it take to become fluent?",
    answer:
      "With consistent practice, significant improvement is usually seen within 3–6 months. Advanced fluency depends on your pace and practice.",
  },
  {
    question: "Do you provide 1:1 mentorship?",
    answer:
      "Yes! Certified German trainers provide personalized feedback on pronunciation, grammar, and speaking skills.",
  },
  {
    question: "Can I practice German for work or travel?",
    answer:
      "Absolutely! Modules include professional communication, travel conversations, and daily life scenarios.",
  },
  {
    question: "Is the course interactive?",
    answer:
      "Yes! You will have speaking challenges, quizzes, listening exercises, and live sessions for active engagement.",
  },
  {
    question: "Do you offer a free demo class?",
    answer:
      "Yes! You can book a free demo to experience our teaching methodology and receive a personalized roadmap.",
  },
];
...
const features = [
  {
    ...
    desc: "Structured lessons from basics to advanced grammar, vocabulary, and sentence construction.",
    icon: "📚",
  },
  {
    title: "Real-Life Conversations",
    desc: "Practice speaking in everyday situations, travel scenarios, and professional settings.",
    icon: "🗣️",
  },
  {
    title: "Personalized Mentorship",
    desc: "1:1 guidance and feedback to improve pronunciation, grammar, and communication skills.",
    icon: "👨‍🏫",
  },
  {
  ...
  },
  {
    ...
    desc: "Learn German culture, idioms, and etiquette to communicate naturally and confidently.",
    icon: "🌍",
  },
  {
    title: "Progress Tracking",
    desc: "Track your improvement weekly and focus on areas needing enhancement.",
    icon: "📊",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-10 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-[#19125e] leading-tight">
              Learn <span className="text-[#f0c44c]">German</span>
              <br />
              Speak Confidently from Beginner to Advanced
            </h1>

            <p className="text-gray-600 mt-6 max-w-lg">
              Master German with BrightMinds! Enhance your speaking, listening,
              reading, and writing skills through interactive lessons, real-life
              conversations, and expert guidance.
            </p>

            <div className="mt-6 space-y-2 text-gray-700">
              <p>✔ Beginner → Advanced structured curriculum</p>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-gray-600 mt-4">
              Everything you need to achieve fluency in German — smart tools,
        ...
        <div className="relative z-10 max-w-7xl px-6 grid md:grid-cols-2 gap-12 items-center justify-center">
          ...
          <div className="text-white max-w-md ml-auto">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-xl text-black">
              <ContactForm
                courses={[{ title: "English", courses: ["German"] }]}
                defaultCourse="German"
              />
            </div>
          </div>
